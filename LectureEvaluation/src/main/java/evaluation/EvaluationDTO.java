...
public class EvaluationDTO {
	...
	public String getSemesterDivde() {
		return semesterDivde;
	}
	public void setSemesterDivde(String semesterDivde) {
		this.semesterDivde = semesterDivde;
	}
	...
	public EvaluationDTO(int evaluationID, String userID, String lectureName, String professorName, int lectureYear,
			String semesterDivde, String lectureDivide, String evaluationTitle, String evaluationContent,
