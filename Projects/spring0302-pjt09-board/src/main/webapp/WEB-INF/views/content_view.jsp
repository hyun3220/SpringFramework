...
<html>
	...
	<body>
	<P> <img src="/board/resources/modify_view.png"></P>
	<table width="500" cellpadding="0" cellspacing="0" border="1">
		...
		<tr >
			<td colspan="2"> 
			<a href="#" onclick="document.getElementById('frm').submit();"><img src="/board/resources/buttons/mod_b.gif"/></a> &nbsp;&nbsp; 
			<a href="list"><img src="/board/resources/buttons/list_b.gif"></a> &nbsp;&nbsp; 
			<a href="delete?b_no=${content_view.b_no}"><img src="/board/resources/buttons/del_b.gif"></a> &nbsp;&nbsp; 
